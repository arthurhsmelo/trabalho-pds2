...
# main
${BUILD_DIR}/main.o: ${INCLUDE_DIR}/System.hpp ${INCLUDE_DIR}/User.hpp ${INCLUDE_DIR}/Post.hpp ${INCLUDE_DIR}/Search.hpp ${INCLUDE_DIR}/Message.hpp ${INCLUDE_DIR}/sqlite3/sqlite3.h ${SRC_DIR}/main.cpp
	${CC} ${CFLAGS} -I ${INCLUDE_DIR}/ -c ${SRC_DIR}/main.cpp -o ${BUILD_DIR}/main.o

# app
${BUILD_DIR}/main: ${BUILD_DIR}/System.o ${BUILD_DIR}/User.o ${BUILD_DIR}/Post.o ${BUILD_DIR}/Search.o ${BUILD_DIR}/Message.o ${BUILD_DIR}/sqlite3.o ${BUILD_DIR}/main.o
